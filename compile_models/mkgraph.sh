...
if [[ ! -s $dir/HCLGa.fst ]]; then
  ...
  cat $dir/determinized_HCLGa.fst | fstrmsymbols $dir/disambig_tid.int > $dir/rmsybol_HCLGa.fst;
  rm $dir/determinized_HCLGa.fst
  validate_fst "$dir/rmsybol_HCLGa.fst" 
  cat $dir/rmsybol_HCLGa.fst | fstrmepslocal > $dir/fstrmepslocal_HCLGa.fst;
  rm $dir/rmsybol_HCLGa.fst
  validate_fst "$dir/fstrmepslocal_HCLGa.fst"
  cat $dir/fstrmepslocal_HCLGa.fst | fstminimizeencoded > $dir/HCLGa.fst.$$ || exit 1; 
  rm fstrmepslocal_HCLGa.fst
...
rm $dir/determinized_HCLGa.fst
rm $dir/rmsybol_HCLGa.fst
rm $dir/fstrmepslocal_HCLGa.fst